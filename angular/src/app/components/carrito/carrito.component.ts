...
export class CarritoComponent implements OnInit {
  ...
  actualizarDisponible(id:number, itemCatalogo:Producto){
    return this.http.put(`https://tienda-angular2-6c29e.firebaseio.com/productos/${id}.json`, itemCatalogo) //Ejecutar el método put a la url de la base de datos enviando como parámetro el objeto Producto con su nuevos valores disponibles
    .map((response : Response) => {
